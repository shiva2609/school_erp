...
export default function StaffProfilePage() {
  ...
  // Assignment state matching staff/page.tsx logic
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-20">
      <Link href="/staff" className="inline-flex items-center gap-2 text-sm font-semibold text-slate-500 hover:text-slate-800 transition-colors">
              ...
              <div className="col-span-2 bg-white rounded-3xl border border-slate-100 p-6 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-y-6 gap-x-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-slate-800 mt-1 capitalize">{staff.gender?.toLowerCase() || 'N/A'}</p>
                  </div>
                  <div>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Date of Birth</p>
                    <p className="font-semibold text-slate-800 mt-1">
                      {staff.date_of_birth ? new Date(staff.date_of_birth).toLocaleDateString('en-IN', { dateStyle: 'long' }) : 'N/A'}
                    </p>
                  </div>
                  <div>
                  ...
                  <div className="col-span-2">
                    ...
                    <p className="font-semibold text-slate-800 mt-1">{staff.specialization || 'N/A'}</p>
                  </div>
                </div>
              </div>
