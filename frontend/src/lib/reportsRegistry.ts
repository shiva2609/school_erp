  ...
  // ═══════════════════════════════
  {
    ...
    reports: [
      ...
      },
      {
        ...
        categoryId: 'payments',
        title: 'Fee Balances',
        description: 'Outstanding fee balances by student. (Included: Core Tuition only. Excluded: Transport, Admission, Special Fees)',
      ...
      },
      {
        ...
        description: 'Payments collected in a date range. (Included: All receipts like Tuition, Transport, Admissions, etc.)',
      ...
      },
      {
        ...
        categoryId: 'payments',
        title: 'Receipts',
        description: 'List of receipts for a date range. (Included: All receipts like Tuition, Transport, Admissions, etc.)',
      ...
      },
      {
        ...
        categoryId: 'payments',
        title: 'Fees Paid',
        description: 'Fees paid breakdown by payment mode. (Included: All receipts regardless of Academic Year)',
